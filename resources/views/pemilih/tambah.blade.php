...
<body>
        ...
        <div class="container">
            ...
            <form class="form-horizontal" role="form" action="/pemilih/store" method="post">
              ...
              {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" id="nik" placeholder="Nomor Induk Keperndudukan" name="nik" class="form-control" autofocus>
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" id="nama" placeholder="Nama lengkap pemilih" name="nama" class="form-control" autofocus>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <select id="Select" name="rt" class="form-control">
                            <option>01</option>
                            <option>02</option>
                            <option>03</option>
                            <option>04</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="date" id="tgl_lahir" placeholder="Pilih tanggal lahir" name="tgl_lahir" class="form-control" autofocus>
